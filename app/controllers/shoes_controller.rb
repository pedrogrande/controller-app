class ShoesController < ApplicationController
  ...
  def new
    @shoe = Shoe.new
    if params[:category]
      @shoe_category = ShoeCategory.find(params[:category])
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @shoe.save
        format.html { redirect_to @shoe, alert: 'Shoe was successfully created.' }
  ...
  private
    ...
    def shoe_params
      params.require(:shoe).permit(:name, :description, :price, :picture, :shoe_category_id)
    end
end
